...
I just built **PerfLens - Web Performance Auditor**, a Chrome extension for real-time web performance monitoring and product launch readiness.

PerfLens gives you a 0-100 performance score, Core Web Vitals tracking, live browser-context audits, prioritized optimization suggestions, root cause summaries, framework and build-mode detection, performance history, and desktop/mobile launch evidence packs with screenshots, videos, and reports.

Lighthouse is great for standardized audits. PerfLens is built for day-to-day product debugging, launch reviews, and helping teams understand what to fix first.

The goal is simple: make web performance clearer, more actionable, and closer to the way developers actually work.

PerfLens - see your web performance clearly.

#WebPerformance #ChromeExtension #FrontendDevelopment #CoreWebVitals #TypeScript #React #DeveloperTools
